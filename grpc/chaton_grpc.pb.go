...
func (x *chatonConnectClient) Send(m *Msg) error {
	return x.ClientStream.SendMsg(m)
}

func (x *chatonConnectClient) Recv() (*Msg, error) {
	m := new(Msg)
...
func (x *chatonConnectServer) Send(m *Msg) error {
	return x.ServerStream.SendMsg(m)
}

func (x *chatonConnectServer) Recv() (*Msg, error) {
	m := new(Msg)
